...
# Environment variable to control cache directory path, ~/.cache/n0vtla will be used by default.
_N0VTLA_DATA_HOME = "N0VTLA_DATA_HOME"
DEFAULT_CACHE_DIR = "~/.cache/n0vtla"

logger = logging.getLogger(__name__)


def get_cache_dir() -> pathlib.Path:
    cache_dir = pathlib.Path(os.getenv(_N0VTLA_DATA_HOME, DEFAULT_CACHE_DIR)).expanduser().resolve()
