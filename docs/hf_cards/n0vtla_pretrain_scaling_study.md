...
| 80% | (uploaded after training finishes) | `stage1_online_80pct/14000` | `n0-vtla-base_plus_stage1_scaling_80pct_14000` |
...
protocol shows **no data-scaling trend**. Contributing factors: temperature 1 with cosine logits compresses
...
**v2 (pending).** Interpretation is appended here once results are in.
